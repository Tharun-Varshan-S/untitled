  ...
  return (
    <header className="h-16 bg-[hsl(var(--background))] border-b border-[hsl(var(--border))] flex items-center justify-between px-6 sticky top-0 z-20">
      <div className="flex items-center gap-6 flex-1">
        ...
        >
          <svg className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[hsl(var(--text-muted))] group-hover:text-[hsl(var(--accent))] transition-colors z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>
          <div className="w-full bg-[hsl(var(--surface))] border border-[hsl(var(--border))] rounded-md h-9 pl-10 pr-12 text-sm text-[hsl(var(--text-muted))] flex items-center truncate whitespace-nowrap overflow-hidden select-none hover:ring-1 hover:ring-[hsl(var(--border-focus))] transition-shadow">
