...
import { ApiKeysSettings } from '@/features/api-keys/components/ApiKeysSettings';

type SettingsTab = 'profile' | 'workspace' | 'apikeys' | 'billing';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
        ...
        <div className="col-span-1 space-y-1">
           <button 
             ...
             className={`w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'profile' ? 'bg-[hsl(var(--surface-elevated))] text-[hsl(var(--text-primary))]' : 'text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface-hover))] hover:text-[hsl(var(--text-primary))]'}`}
           >
              Profile
           </button>
           <button 
             onClick={() => setActiveTab('workspace')}
             className={`w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'workspace' ? 'bg-[hsl(var(--surface-elevated))] text-[hsl(var(--text-primary))]' : 'text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface-hover))] hover:text-[hsl(var(--text-primary))]'}`}
           >
              Workspace
           </button>
           <button 
             onClick={() => setActiveTab('apikeys')}
             className={`w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'apikeys' ? 'bg-[hsl(var(--surface-elevated))] text-[hsl(var(--text-primary))]' : 'text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface-hover))] hover:text-[hsl(var(--text-primary))]'}`}
           >
              API Keys
           </button>
           <button 
             onClick={() => setActiveTab('billing')}
             className={`w-full flex items-center justify-between px-3 py-2 text-sm font-medium rounded-md transition-colors ${activeTab === 'billing' ? 'bg-[hsl(var(--surface-elevated))] text-[hsl(var(--text-primary))]' : 'text-[hsl(var(--text-secondary))] hover:bg-[hsl(var(--surface-hover))] hover:text-[hsl(var(--text-primary))]'}`}
           >
              Billing
           </button>
        </div>
        ...
        <div className="col-span-1 lg:col-span-3 space-y-6">
          ...
          {(activeTab === 'workspace' || activeTab === 'billing') && (
            <div className="card-premium overflow-hidden p-8 text-center">
              <h3 className="text-lg font-medium text-[hsl(var(--text-primary))]">Coming Soon</h3>
